...
//     const initialEngagements = selectEngagementsForHex({
//       hexID: startHex.id,
//       boardHexes,
//       gameUnits,
//       armyCards,
...
//         boardHexes
//       ).map((hex) => hex.id)
//       const isStartHexWater = fromHex.terrain === 'water'
//       const isNeighborHexWater = toHex.terrain === 'water'
